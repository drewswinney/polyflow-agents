...
import { useCreateSession, useSessions, useSessionSearch } from '@/state/queries'
...
export default function SessionsScreen() {
  ...
  const startSession = () => createSession.mutate(undefined, { onSuccess: openSession })
    ...
    <View style={[styles.screen, { backgroundColor: theme.color.bg }]}>
      ...
      >
        ...
        {searchActive ? (
          ...
          <>
            <NewSessionButton onPress={startSession} />
